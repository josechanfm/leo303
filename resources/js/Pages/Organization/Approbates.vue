    ...
    methods: {
        ...
        storeRecord(){
            ...
            this.$refs.modalRef.validateFields().then(()=>{
                this.$inertia.post(route('manage.approbates.store') , this.modal.data, {
                    onSuccess:(page)=>{
        ...
        updateRecord(){
            ...
            this.$refs.modalRef.validateFields().then(()=>{
                ...
                this.$inertia.post(route('manage.approbates.update',this.modal.data.id), this.modal.data,{
                    onSuccess:(page)=>{
                        this.modal.isOpen=false;
                        console.log(page);
                    },
        ...
        deleteRecord(record){
            ...
            this.$inertia.delete(route('manage.approbates.destroy', record.id),{
                onSuccess: (page)=>{
                    console.log(page);
                },
                onError: (error)=>{
