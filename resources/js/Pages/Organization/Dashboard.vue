            ...
            <div class="flex flex-col-reverse md:flex-row gap-6">
                <div class="flex-auto">
                    <div class="container mx-auto mt-5 bg-white rounded-lg p-2 h-full">
                        <inertia-link v-if="member" :href="route('member.dashboard')"
                        ...
                        <div class="bg-white relative shadow rounded-lg">
                            ...
                            <div class="w-full">
                                <h3 class="font-medium text-gray-900 text-left px-6">
                                    {{ $t('my_organizations') }}
                                    <inertia-link :href="route('manage.organizations.index')"
                                        class="float-right">{{ $t('organization_list') }}</inertia-link>
                                </h3>
                                    ...
                                    <template v-for="org in organizations">
                                        <a href="#"
                                            ...
                                            <span class="text-gray-500 text-xs float-right">
                                                <inertia-link
                                                    :href="route('manage.organizations.edit', org.id)">{{ $t('edit')
                                                    }}</inertia-link>
                                            </span>
