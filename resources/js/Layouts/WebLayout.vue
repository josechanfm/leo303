...
<template>
  ...
  <header>
    <!-- navbar and menu -->
    <nav class="shadow bg-gradient-to-r from-blue-600 to-blue-300">
        ...
        <div>
          ...
          <div class="flex items-center">
            <ul class="sm:flex space-x-4 hidden items-center text-white">
              <li>
                <a href="https://onlinejua.org" target="_blank"
              ...
              <template v-if="$page.props.user.id">
                <li>
                  <a :href="route('member.dashboard')" target="_blank"
                    class="text-bold text-white hover:text-yellow-300 text-md">{{ $t("memberDashboard") }}</a>
                </li>
                <li>
        ...
        <div class="h-96 col-span-1">
          ...
          <div class="bg-white rounded-md">
            ...
            <div class="bg-white rounded-md list-none text-center">
              ...
              <li class="py-3 border-b-2">
                <a href="https://www.sport.gov.mo/pt" class="list-none hover:text-indigo-600" target="_blank">澳門體育局</a>
              </li>
            </div>
          </div>
        </div>
