...
class Competition extends Model implements HasMedia
{
    ...
    protected $fillable=['organization_id','score_category','title_zh','title_fn','brief','description','start_date','end_date','match_dates','categories_weights','roles','scope','for_member','staff_options','referee_options','fee','published'];
